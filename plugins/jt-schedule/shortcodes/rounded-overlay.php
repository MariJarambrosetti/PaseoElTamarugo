...
<div class="schedule-rounded-overlay">
	<?php
...
?>
	...
	<div class="uk-width-1-5">
		<figure class="uk-overlay uk-overlay-hover">
			...
			?>
				<figcaption class="uk-overlay-panel uk-flex uk-flex-middle uk-flex-center uk-overlay-slide-bottom uk-overlay-background">
					<div>
						<?php
							if ( $options[jt_schedule_singlePage] == '1' ) {
						?>
