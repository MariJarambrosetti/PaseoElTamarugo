<div class="uk-grid jt-event-calendar-default-3">
<?php
			...
			echo '<div class="uk-width-1-2">';
					...
					if ( ( ! empty($event_start_date)) || ( ! empty($event_end_date)) || ( ! empty($event_location)) ) {
						...
						if ( ! empty($event_location)) {
							echo '<span class="event-separator">/</span><span class="event-location"><i class="fa fa-map-marker"></i>' . esc_attr( $event_location ) . '</span>';
						}
