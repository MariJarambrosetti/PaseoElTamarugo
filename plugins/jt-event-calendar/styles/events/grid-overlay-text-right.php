<div class="uk-grid jt-event-calendar-grid-overlay-text-right">
<?php
			...
			echo '<div class="uk-width-1-2">';
					...
					if ( $event_img != NULL ) {
						echo '<figure class="uk-overlay uk-overlay-hover">';
							...
							echo '<figcaption class="uk-overlay-panel uk-overlay-right uk-overlay-background uk-ignore"><div>';
