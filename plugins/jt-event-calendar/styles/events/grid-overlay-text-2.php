<div class="uk-grid jt-event-calendar-grid-overlay-text-2">
<?php
			...
			echo '<div class="uk-width-1-4">';
					...
					if ( $event_img != NULL ) {
						echo '<figure class="uk-overlay uk-overlay-hover">';
							...
							echo '<figcaption class="uk-overlay-panel uk-flex uk-flex-bottom uk-overlay-background uk-overlay-slide-bottom"><div>';
