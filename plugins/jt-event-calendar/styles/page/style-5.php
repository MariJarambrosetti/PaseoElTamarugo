	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<div class="container">
				...
				<div class="col-md-4">
					<div class="event-info-section">
						<?php
							...
							if ((!empty ($location)) || (!empty ($starts)) || (!empty ($time)) || (!empty ($free_entrance))) {
						?>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="event-info">
						<h3>
							<span><?php echo __($info_text, 'jt-event-calendar'); ?></span>
						</h3>
						<?php echo $event_info; ?>
					</div>
					<?php
				...
				<div class="col-md-6">
					...
					<div class="event-tickets">
						<h3>
							<span><?php echo __($tickets_text, 'jt-event-calendar'); ?></span>
						</h3>
					...
					?>
					<h3>
						<span><?php echo __($event_location_text, 'jt-event-calendar'); ?></span>
					</h3>
					<?php
							echo $map;
						}
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="event-video">
						<h3>
							<span><?php echo __($event_video, 'jt-event-calendar'); ?></span>
						</h3>
				...
				<div class="col-md-6">
					...
					<div class="event-gallery">
						<h3>
							<span><?php echo __($photo_gallery_text, 'jt-event-calendar'); ?></span>
						</h3>
						<?php
							if (!empty ($img1)) {
						?>
			...
			<div class="event-sponsors">
				<h3>
					<span><?php echo __($sponsors_text, 'jt-event-calendar'); ?></span>
				</h3>
			...
			<div class="event-sponsors">
				<h3>
					<span><?php echo __($media_sponsors_text, 'jt-event-calendar'); ?></span>
				</h3>
				<div class="uk-grid sponsors-list">
					<?php
