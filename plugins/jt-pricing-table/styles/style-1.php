<div class="uk-grid jsquare-pricing-1">
	<style>
		<?php
			if ($num_columns == '3') {
		?>
		.jsquare-pricing-1 .uk-width-1-3:nth-child(2) .pricing_btn a:hover {
			color: <?php echo $button_color_1; ?> !important;
		}
		.jsquare-pricing-1 .uk-width-1-3:nth-child(3) .pricing_btn a:hover {
			color: <?php echo $button_color_2; ?> !important;
		}
		.jsquare-pricing-1 .uk-width-1-3:nth-child(4) .pricing_btn a:hover {
		...
		?>
		.jsquare-pricing-1 .uk-width-1-4:nth-child(2) .pricing_btn a:hover {
			color: <?php echo $button_color_1; ?> !important;
		}
		.jsquare-pricing-1 .uk-width-1-4:nth-child(3) .pricing_btn a:hover {
			color: <?php echo $button_color_2; ?> !important;
		}
		.jsquare-pricing-1 .uk-width-1-4:nth-child(4) .pricing_btn a:hover {
			color: <?php echo $button_color_3; ?> !important;
		}
		.jsquare-pricing-1 .uk-width-1-4:nth-child(5) .pricing_btn a:hover {
