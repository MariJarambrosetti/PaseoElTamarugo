<div class="uk-grid jsquare-pricing-3">
	<style>
		<?php
			if ($num_columns == '3') {
		?>
		.jsquare-pricing-3 .uk-width-1-3:nth-child(2) .triangle-down {
			background: <?php echo $price_color_1; ?> !important;
		}
		.jsquare-pricing-3 .uk-width-1-3:nth-child(3) .triangle-down {
			background: <?php echo $price_color_2; ?> !important;
		}
		.jsquare-pricing-3 .uk-width-1-3:nth-child(4) .triangle-down {
		...
		?>
		.jsquare-pricing-3 .uk-width-1-4:nth-child(2) .triangle-down {
			background: <?php echo $price_color_1; ?> !important;
		}
		.jsquare-pricing-3 .uk-width-1-4:nth-child(3) .triangle-down {
			background: <?php echo $price_color_2; ?> !important;
		}
		.jsquare-pricing-3 .uk-width-1-4:nth-child(4) .triangle-down {
			background: <?php echo $price_color_3; ?> !important;
		}
		.jsquare-pricing-3 .uk-width-1-4:nth-child(5) .triangle-down {
...
<?php
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( $buy_button == 'show') {
			echo '<div class="pricing_btn"><p><a href="' . $buy_button_url . '" style="background: ' . $button_color_1 . '">' . $buy_button_text . '</a></p></div>';
		}
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( $buy_button_2 == 'show') {
			echo '<div class="pricing_btn"><p><a href="' . $buy_button_url_2 . '" style="background: ' . $button_color_2 . '">' . $buy_button_text_2 . '</a></p></div>';
		}
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( $buy_button_3 == 'show') {
			echo '<div class="pricing_btn"><p><a href="' . $buy_button_url_3 . '" style="background: ' . $button_color_3 . '">' . $buy_button_text_3 . '</a></p></div>';
		}
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( $buy_button_4 == 'show') {
			echo '<div class="pricing_btn"><p><a href="' . $buy_button_url_4 . '" style="background: ' . $button_color_4 . '">' . $buy_button_text_4 . '</a></p></div>';
		}
