<div class="uk-grid jsquare-pricing-5">
	<style>
		<?php
			if ($num_column == '3') {
		?>
		.jsquare-pricing-5 .uk-width-1-3:nth-child(2) .pricing_btn a:hover {
			color: <?php echo $button_color_1; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_1; ?> !important;
		}
		.jsquare-pricing-5 .uk-width-1-3:nth-child(3) .pricing_btn a:hover {
			color: <?php echo $button_color_2; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_2; ?> !important;
		}
		.jsquare-pricing-5 .uk-width-1-3:nth-child(4) .pricing_btn a:hover {
		...
		?>
		.jsquare-pricing-5 .uk-width-1-4:nth-child(2) .pricing_btn a:hover {
			color: <?php echo $button_color_1; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_1; ?> !important;
		}
		.jsquare-pricing-5 .uk-width-1-4:nth-child(3) .pricing_btn a:hover {
			color: <?php echo $button_color_2; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_2; ?> !important;
		}
		.jsquare-pricing-5 .uk-width-1-4:nth-child(4) .pricing_btn a:hover {
			color: <?php echo $button_color_3; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_3; ?> !important;
		}
		.jsquare-pricing-5 .uk-width-1-4:nth-child(5) .pricing_btn a:hover {
...
<?php
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( ! empty($price_3) && ($style == 'style-5')) {
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( ! empty($price_4) && ($style == 'style-5')) {
