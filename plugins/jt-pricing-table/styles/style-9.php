<div class="uk-grid jsquare-pricing-9">
	<style>
		<?php
			if ($num_columns == '3') {
		?>
		.jsquare-pricing-9 .uk-width-1-3:nth-child(2) .pricing_btn a:hover {
			color: <?php echo $button_color_1; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_1; ?> !important;
		}
		.jsquare-pricing-9 .uk-width-1-3:nth-child(3) .pricing_btn a:hover {
			color: <?php echo $button_color_2; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_2; ?> !important;
		}
		.jsquare-pricing-9 .uk-width-1-3:nth-child(4) .pricing_btn a:hover {
		...
		?>
		.jsquare-pricing-9 .uk-width-1-4:nth-child(2) .pricing_btn a:hover {
			color: <?php echo $button_color_1; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_1; ?> !important;
		}
		.jsquare-pricing-9 .uk-width-1-4:nth-child(3) .pricing_btn a:hover {
			color: <?php echo $button_color_2; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_2; ?> !important;
		}
		.jsquare-pricing-9 .uk-width-1-4:nth-child(4) .pricing_btn a:hover {
			color: <?php echo $button_color_3; ?> !important;
			background: #fff !important;
			border: 1px solid <?php echo $button_color_3; ?> !important;
		}
		.jsquare-pricing-9 .uk-width-1-4:nth-child(5) .pricing_btn a:hover {
...
<?php
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( ! empty($plan)) {
			echo '<div class="jsquare-pt-top-text"><p style="color: ' . $plan_color_1 . '">' . esc_html( $plan ) . '</p></div>';
			echo '<div class="triangle-down"><div class="triangle-down-left"></div><div class="triangle-down-right"></div></div>';
		}

		if ( ! empty($price)) {
			echo '<div class="jsquare-pt-price" style="color: ' . $price_color_1 . '"><p><sup>' . esc_html( $currency_symbol ) . '</sup>' . esc_html( $price ) . '</p></div>';
		}
		...
		if ( $buy_button == 'show') {
			echo '<div class="pricing_btn"><p><a href="' . $buy_button_url . '" style="background: ' . $button_color_1 . '; border: 1px solid ' . $button_color_2 . '">' . $buy_button_text . '</a></p></div>';
		}
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( ! empty($plan_2)) {
			echo '<div class="jsquare-pt-top-text"><p style="color: ' . $plan_color_2 . '">' . esc_html( $plan_2 ) . '</p></div>';
			echo '<div class="triangle-down"><div class="triangle-down-left"></div><div class="triangle-down-right"></div></div>';
		}
		
		if ( ! empty($price_2)) {
			echo '<div class="jsquare-pt-price" style="color: ' . $price_color_2 . '"><p><sup>' . esc_html( $currency_symbol ) . '</sup>' . esc_html( $price_2 ) . '</p></div>';
		}
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( ! empty($plan_3)) {
			echo '<div class="jsquare-pt-top-text"><p style="color: ' . $plan_color_3 . '">' . esc_html( $plan_3 ) . '</p></div>';
			echo '<div class="triangle-down"><div class="triangle-down-left"></div><div class="triangle-down-right"></div></div>';
		}

		if ( ! empty($price_3)) {
			echo '<div class="jsquare-pt-price" style="color: ' . $price_color_3 . '"><p><sup>' . esc_html( $currency_symbol ) . '</sup>' . esc_html( $price_3 ) . '</p></div>';
		}
	...
	<?php } echo __('<div class="pricing-box">');
		...
		if ( ! empty($plan_4)) {
			echo '<div class="jsquare-pt-top-text"><p style="color: ' . $plan_color_4 . '">' . esc_html( $plan_4 ) . '</p></div>';
			echo '<div class="triangle-down"><div class="triangle-down-left"></div><div class="triangle-down-right"></div></div>';
		}

		if ( ! empty($price_4)) {
			echo '<div class="jsquare-pt-price" style="color: ' . $price_color_4 . '"><p><sup>' . esc_html( $currency_symbol ) . '</sup>' . esc_html( $price_4 ) . '</p></div>';
		}
