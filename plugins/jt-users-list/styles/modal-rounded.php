<?php
	...
	echo '<div class="uk-width-1-4">
		...
		if ( ! empty(${'img'.$i})) {
			echo '<a href="' . '#user-box-rounded-'.$i . '" data-uk-modal="{center:true}"><figure class="uk-overlay uk-overlay-hover">
					<img src="' . ${'img'.$i} . '" alt="">
	...
	echo '<div id="' . 'user-box-rounded-'.$i . '" class="uk-modal grid-modal grid-modal-rounded">
