...
?>
	<div class="uk-slidenav-position large-slideset" data-uk-slideset="{small: 1, medium: 3, large: 4}">
				...
				foreach($posts_array as $post) {
					...
					echo '<li><figure class="uk-overlay uk-overlay-hover">
							<a href="' . get_permalink( $post->ID ) . '">
								...
								echo '</div>';
								echo '<figcaption class="uk-overlay-panel uk-overlay-bottom uk-overlay-background uk-ignore">' . $post->post_title;
