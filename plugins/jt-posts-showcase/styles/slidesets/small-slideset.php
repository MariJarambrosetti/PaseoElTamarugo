...
?>
	...
	<div class="uk-slidenav-position small-slideset" data-uk-slideset="{small: 1, medium: 2, large: 2}">
				...
				foreach($posts_array as $post) {
					...
					echo '<li><figure class="uk-overlay uk-overlay-hover">
							<a href="' . get_permalink( $post->ID ) . '">
								...
								echo '</div>';
								echo '<figcaption class="uk-overlay-panel uk-overlay-bottom uk-ignore uk-overlay-background">' 
								. $post->post_title;
