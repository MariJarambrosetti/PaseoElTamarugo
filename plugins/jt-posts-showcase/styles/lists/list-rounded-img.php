...
?>
	<div class="showcase-list-rounded-img">
		<?php
			...
			echo '<div class="posts-showcase-items">';
				...
				foreach($posts_array as $post) {
					...
					echo '<div class="row">';
						echo '<div class="post-img uk-overlay uk-overlay-hover"><a href="' . get_permalink( $post->ID ) . '"><img src="' . wp_get_attachment_url( get_post_thumbnail_id($post->ID), 'thumbnail'  ) . '" alt=""></a>';
