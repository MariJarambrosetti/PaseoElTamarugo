...
<div class="uk-grid-width-small-1-1 uk-grid-width-medium-1-1 uk-grid-width-large-1-1 projects-sidebar-default" data-uk-grid="{controls: '#filter-list'}">
	<?php
	...
	<div class="uk-grid" <?php if ($display_filters == 'yes') { ?>data-uk-filter="<?php echo $project_filter; ?>" <?php } ?>>
		...
		<div class="uk-width-1-2 general-info">
