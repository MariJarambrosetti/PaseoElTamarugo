...
<div class="uk-grid-width-small-1-2 uk-grid-width-medium-1-3 uk-grid-width-large-1-4 projects-grid-4-cols uk-grid-match" data-uk-grid="{controls: '#filter-list'}">
	<?php
	...
	<div <?php if ($display_filters == 'yes') { ?>data-uk-filter="<?php echo rtrim(${'filter' . $i}); ?>" <?php } ?>>
		<figure class="uk-overlay">
			...
			<figcaption class="uk-overlay-panel uk-flex uk-flex-bottom uk-overlay-background">
				<div>
