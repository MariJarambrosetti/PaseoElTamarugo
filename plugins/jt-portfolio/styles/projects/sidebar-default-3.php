...
<div class="uk-grid-width-small-1-2 uk-grid-width-medium-1-3 uk-grid-width-large-1-2 projects-sidebar-default-3 uk-grid-match" data-uk-grid="{controls: '#filter-list'}">
	<?php
