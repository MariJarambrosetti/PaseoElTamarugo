...
<div class="projects-slideset-rounded-img uk-slidenav-position" data-uk-slideset="{small: 1, medium: 2, large: 3, controls: '#filter-list'}">
	...
	?>
	<li <?php if ($display_filters == 'yes') { ?>data-uk-filter="<?php echo $project_filter; ?>" <?php } ?>>
		<figure class="uk-overlay">
			<?php $project_img = wp_get_attachment_url( get_post_thumbnail_id($post->ID), 'thumbnail'  ); ?>
			<a href="<?php echo get_permalink( $post->ID); ?>"><img src="<?php echo $project_img; ?>" alt=""></a>
				<div>
