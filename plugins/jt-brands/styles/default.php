...
?>
<ul id="filter-list">
    <li data-uk-filter=""><a href=""></a><?php _e('All', 'jt-brands'); ?></li>
	<?php
...
<div class="uk-grid-width-small-1-2 uk-grid-width-medium-1-2 uk-grid-width-large-1-4 brands-default uk-grid-match" data-uk-grid="{controls: '#filter-list'}">
	<?php
	...
	?>
	<div <?php if ($display_filters == 'yes') { ?>data-uk-filter="<?php echo $cat_link; ?>" <?php } ?>>
