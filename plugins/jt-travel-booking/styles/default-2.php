<div class="uk-grid-width-small-1-1 uk-grid-width-medium-1-2 uk-grid-width-large-1-3 destinations-default-2 uk-grid-match" data-uk-grid>
	<?php
	...
	<div>
		<figure class="uk-overlay uk-overlay-hover">
			...
			<figcaption class="uk-overlay-background uk-overlay-bottom uk-ignore uk-overlay-panel">
		...
		?>
		<div class="price">
			<span><?php echo $destination_price; ?></span>
		</div>
		<?php
			}
		?>
		...
		<div class="uk-grid">
			...
			<div class="uk-width-1-2 destination-days">
				<?php echo esc_html( $destination_days ); ?> <?php echo __($travel_days_text, 'jt-travel-booking'); ?>
			</div>
			<?php } ?>
			<div class="uk-width-1-2 destination-more-info">
