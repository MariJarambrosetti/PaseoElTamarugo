<?php
	require( trailingslashit( get_template_directory() ) . 'inc/colors/photofolio.php' );

	include_once ABSPATH . 'wp-admin/includes/plugin.php';
	if ( is_plugin_active( 'option-tree/ot-loader.php' ) ) {
		$photofolio_header_width = esc_attr(ot_get_option('photofolio-header-width'));
		$photofolio_social_width = esc_attr(ot_get_option('photofolio-social-width'));
	}
	else {
		$photofolio_header_width = 'col-md-8';
		$photofolio_social_width = 'col-md-4';
	}
?>
<header id="masthead" class="site-header">
		<div class="container">
			<div class="row">
				<div class="<?php echo $photofolio_header_width; ?>">
				...
				<div id="social" class="<?php echo $photofolio_social_width; ?>">
					<?php 
